    ...
    <div className="h-64" role="img" aria-label={summary}>
      <ResponsiveContainer width="100%" height="100%">
        <ComposedChart data={data} margin={{ top: 6, right: 12, left: -8, bottom: 0 }}>
          ...
          <Bar yAxisId="left" dataKey="starts" name="Sessions started" fill="var(--pc-accent)" radius={[3, 3, 0, 0]} />
          <Line yAxisId="right" type="monotone" dataKey="medianMinutes" name="Median minutes" stroke="var(--pc-accent-2)" strokeWidth={2} dot={false} isAnimationActive={false} />
          {data.length > 8 && (
